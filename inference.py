...
parser.add_argument('--image_path', default='/data/cvpr/CROHME/19_test_images.pkl', type=str, help='测试image路径')
parser.add_argument('--label_path', default='/data/cvpr/CROHME/19_test_labels.txt', type=str, help='测试label路径')
parser.add_argument('--word_path', default='/data/cvpr/CROHME/words_dict.txt', type=str, help='测试dict路径')
